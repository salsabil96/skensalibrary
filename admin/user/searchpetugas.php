<?php
  ...
  $pp = "SELECT * FROM petugas WHERE id_petugas like '%$keyword%' or nama_petugas like '%$keyword%' or jk like '%$keyword%' or email like '%$keyword%' or status like '%$keyword%' or id_user like '%$keyword%'";
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="breadcrumb">
          ...
          <li><i class="fa fa-file-text-o"></i>Search Data Petugas</li>
        </ul>
      </div>
    </div>
