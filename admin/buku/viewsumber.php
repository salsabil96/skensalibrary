...
<section id="main-content">
  <section class="wrapper">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        <ul class="pagination pagination pull-left">
         ...
         if($page>1){
           $link=$page-1; 
           echo" <li><a href='admin.php?id=sumber&halaman=$link'>«</a></li> "; }
           else { $prev = ""; }
           for ($i=1; $i<=$pages; $i++){ ?>
    ...
    <div class="col-lg-4"><br>
      <form class="form-inline pull-right" role="form" method="post" action="admin.php?id=searchsumber">
  ...
  <?php
  $result = mysqli_query($koneksi, "SELECT * FROM sumber ORDER BY nama_sumber LIMIT $mulai, $halaman");
  $total = mysqli_num_rows($result);
    ...
    <div class="row">
      <div class="col-lg-12">
        <table class="table table-striped table-advance table-hover">
          <tbody>
            <tr>
              <th>No</th><th>ID Sumber</th><th>Nama Sumber</th><th>Action</th></tr> 
