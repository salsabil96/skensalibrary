...
$result = mysqli_query($koneksi, "SELECT * FROM pengarang");
$no=$mulai+1;
...
<section id="main-content">
  <section class="wrapper">
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="breadcrumb">
          ...
          <li><i class="fa fa-laptop"></i>Data Pengarang</li>
        </ul>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-5"><br>
        <a class="btn btn-primary" href="admin.php?id=addpengarang"><i class="icon_plus_alt2"></i> Tambah Pengarang</a>
      </div>
      <div class="col-lg-3">
        <ul class="pagination pagination pull-left">
         ...
         if($page>1){
           $link=$page-1; 
           echo" <li><a href='admin.php?id=pengarang&halaman=$link'>«</a></li> "; }
           else { $prev = ""; }
           for ($i=1; $i<=$pages; $i++){ ?>
            <li><a href="admin.php?id=pengarang&halaman=<?php echo $i; ?>"><?php echo $i; ?></a></li>
          <?php }
    ...
    <div class="col-lg-4"><br>
      <form class="form-inline pull-right" role="form" method="post" action="admin.php?id=searchpengarang">
  ...
  <?php
  $result = mysqli_query($koneksi, "SELECT * FROM pengarang ORDER BY nama_pengarang LIMIT $mulai, $halaman");
  $total = mysqli_num_rows($result);
    ...
    <div class="row">
      <div class="col-lg-12">
        <table class="table table-striped table-advance table-hover">
          <tbody>
            <tr><th>No</th><th>ID Pengarang</th><th>Nama Pengarang</th><th>Action</th></tr> 
