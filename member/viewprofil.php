<?php
$ambil = mysqli_query($koneksi, "SELECT * FROM anggota RIGHT OUTER JOIN user on (anggota.id_user=user.id_user) WHERE user.id_user='$id_user'");
        ...
        <table class="table table-bordered table-striped table-hover">
          <tbody>
            <tr>
              <?php
              if($data[7]!=NULL)
                echo "<th rowspan='11' width='25%'><img src='./images/profil/$data[7]' width='270px' height='365px'></img></th>"; 
              else
              echo "<th rowspan='11' width='25%'><img src='./images/profil/nophoto.png' width='270px' height='345px'></img></th>"; 
             ?>
